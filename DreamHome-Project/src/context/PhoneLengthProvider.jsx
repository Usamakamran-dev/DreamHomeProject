...
export const PhoneLengthContext=React.createContext();

function PhoneLengthProvider(props){
    const phoneLengthData=[
      ...
      return(
        <PhoneLengthContext.Provider value={phoneLengthData}>
         {props.children}
        </PhoneLengthContext.Provider>
      )
     
}

export default PhoneLengthProvider;