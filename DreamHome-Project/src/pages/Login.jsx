         ...
         <div className="row overflow-hidden m-0 px-0 gap-5">
            <div className="col-12 col-md-4 d-flex flex-column justify-content-center gap-5 px-3 px-md-5">
               <div className='d-flex flex-column align-items-center align-items-md-start gap-2'>
                ...
                <h1 className="fs-1 fw-bold font-color-secondary m-0">Welcome <span className="font-color-primary">Back !</span></h1>
                <p className='fw-medium fs-6 text-center font-color-light m-0'>Lorem ipsum lorem ispum ipsum lorem ipsum</p>
               </div>
             ...
             <button className="button-hover-primary py-3 fs-para w-100 fw-bold text-white background-color-primary border-0 rounded">LOG IN</button>
