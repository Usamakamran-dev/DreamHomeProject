  ...
  const showFooter=useShowFooter();
    ...
    return(
        <div className="px-2 px-md-5 py-5 d-flex flex-column align-items-center gap-2 gap-md-5">
          ...
          <p className="font-color-light fw-medium px-2 px-md-5 text-center fs-mobile">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed eu nisi quis urna imperdiet vehicula. 
