    ...
    return(
         ...
         <div className="d-flex flex-column align-items-center align-items-md-start justify-content-between gap-4 gap-md-2 px-4 py-3 py-md-0 px-md-5">
            ...
            <p className="font-color-light fs-6 m-0 text-center text-md-start">DAMAC Hills community is a well-established self-contained community comprising villas, apartments and a hotel. Home to the Trump International Golf Club Dubai, it also boasts nearly four million square feet of parkland offering various themed areas for relaxation and sports – including restful gardens and lakes, a skate park, stables, football field, tennis courts and more. 
             ...
             <button className="py-3 fs-para project-button-width fw-bold text-white background-color-primary border-0 rounded">ENQUIRE NOW</button>
             <button className="py-3 fs-para project-button-width fw-bold font-color-light border-0 rounded">DOWNLOAD BROCHURE</button>
             </div>
        ...
        <p className="text-white fs-6 m-0 text-center text-md-start ">DAMAC Hills is located along Umm Suqeim Road, with
         easy access to the city’s major road networks, and proximity to all key business and leisure
          ...
          <button className="py-3 project-button-width fs-para fw-bold text-white background-color-secondary border-0 rounded">VIEW ON GOOGLE MAP</button>
         </div>
         </div>
         </div>
