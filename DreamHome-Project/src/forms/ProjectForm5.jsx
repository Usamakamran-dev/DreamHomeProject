    ...
    return(
            <div className="bg-white p-3 p-md-4 rounded d-flex flex-column gap-2">
                <div className="d-flex flex-row align-items-start justify-content-between">
                  ...
                  <h1 className="h-mobile fw-bold font-color-primary m-0">STEP 5</h1>
                  <p className="fw-medium font-color-secondary fs-mobile">Project Amenities</p>
                  </div>
