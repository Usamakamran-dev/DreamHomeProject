    ...
    return(
        <div className="px-3 py-2 background-color-primary px-md-4 py-md-4 flex-1 rounded d-flex flex-column align-items-center justify-content-between gap-4">
         ...
         <div className="d-flex flex-column align-items-center gap-2">
              ...
              className="m-0 background-color-secondary text-white rounded py-2 d-flex align-items-center justify-content-center fw-semibold fs-6 no-wrap">AED  
              <span className="m-0 fw-bold fs-3 text-white px-1"> {props.price}</span>
            </label>
        </div>
        </div> )}
