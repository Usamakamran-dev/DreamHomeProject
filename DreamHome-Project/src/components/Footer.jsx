...
function Footer() {
  return (
    <nav className="container-fluid bg-white shadow-lg fixed-bottom mt-5">
        <div className="py-3 px-0 px-md-5 d-flex flex-row align-items-end justify-content-around">
          <div className="d-flex flex-column align-items-center gap-1">
            ...
            <label className="fw-semibold font-color-primary">Enquiry</label>
          </div>
          
          <div className="d-flex flex-column align-items-center gap-1">
            <img src={phone} alt="Footer-Icon" className='footer-icon w-auto' style={{height: '1.5rem'}}   />
            <label className="fw-semibold font-color-primary">Call</label>
          </div>
          ...
          <a href="https://web.whatsapp.com" className="text-decoration-none">
            <div className="d-flex flex-column align-items-center gap-1">
              ...
              <label className="fw-semibold font-color-primary">Whatsapp</label>
            </div>
          </a>
          
          <div className="d-flex flex-column align-items-center gap-1">
            <img src={contact} alt="Footer-Icon" className='footer-icon w-auto' style={{height: '1.6rem'}}  />
            <label className="fw-semibold font-color-primary">Contact</label>
          </div>
        </div>
      </nav>
      )}
